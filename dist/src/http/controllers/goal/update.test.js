...
(0, vitest_1.describe)('Update goal', () => {
    (0, vitest_1.it)('should be able to update a goal', async () => {
        ...
        const getUpdatedGoal = await prisma_1.prisma.goal.findUniqueOrThrow({
            where: { id: goal.id },
        });
        (0, vitest_1.expect)(getUpdatedGoal.description).toEqual('Updated description');
    });
});
