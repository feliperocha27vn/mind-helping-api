...
const get_number_patients_1 = require("./get-number-patients");
let hourlyRepository;
let personRepository;
let professionalRepository;
let schedulingRepository;
let sut;
(0, vitest_1.describe)('Get patients by professional', () => {
    (0, vitest_1.beforeEach)(() => {
        ...
        sut = new get_number_patients_1.GetNumberPatientsUseCase(schedulingRepository, professionalRepository);
    ...
    (0, vitest_1.it)('should be able to get a scheduling', async () => {
        ...
        (0, vitest_1.expect)(numberPatients).toEqual(2);
    });
});
